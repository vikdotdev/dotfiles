;;; vikdotdev-dracula-theme.el -*- lexical-binding: t; -*-
;;
...
;; Homepage: https://github.com/vik/vikdotdev-dracula-theme
;; Package-Requires: ((emacs "24.3"))
;;
;; This file is not part of GNU Emacs.
;;
;;; Commentary:
;; Theme customized from doom-dracula theme
;; TODO: customize ivy? and swiper colors
;;
;;; Code:
(require 'doom-themes)
...
;;
(def-doom-theme vikdotdev-dracula
  "A dark theme based on Dracula theme"

  ;; name        default   256       16
  ((bg         '("#282a36" "#121212" nil            ))
...
(provide 'vikdotdev-dracula-theme)
;;; vikdotdev-dracula-theme.el ends here
