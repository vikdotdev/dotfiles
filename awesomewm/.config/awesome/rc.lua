...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86MonBrightnessUp", function() os.execute("set-backlight -i 5") end),
    awful.key({}, "XF86MonBrightnessDown", function() os.execute("set-backlight -d 5") end),
