...
** Window management
Pressing =ESC= 3 times will maximize current window, but loses any previous layout.
...
#+end_src
** Searching
Temporarily disabled to see if I can get used to default emacs way of searching:
