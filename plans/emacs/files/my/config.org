...
(setq org-format-latex-options
      (plist-put org-format-latex-options :scale 1.40))
...
#+end_src
** TODO Export
This produces weird markdown that is not always rendered properly in Notion. Maybe I should do a Github flavored markdown instead:
#+begin_src elisp
(defun vik/org-to-clipboard-as-markdown ()
  (interactive)
  (save-window-excursion
    (let ((org-export-with-toc nil)) ;; Correct let-binding
