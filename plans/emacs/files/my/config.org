...
#+begin_src elisp
(defun vik/enable-hl-line ()
  "Enable hl-line-mode for all allowed mode types."
  (unless (derived-mode-p 'vterm-mode)
    (hl-line-mode 1)))

(add-hook 'text-mode-hook 'vik/enable-hl-line)
(add-hook 'prog-mode-hook 'vik/enable-hl-line)
#+end_src
